...
public class S2MotherNaveShape2D extends NaveShape2D {

	private S2MotherStateNaveShape2D normalStateS2D; 
	private S2MotherStateNaveShape2D shotedStateS2D; 
	private S2MotherStateNaveShape2D lowStateS2D;
	private S2MotherStateNaveShape2D destroyedStateS2D; 
	private S2MotherStateNaveShape2D inactiveStateS2D;

	private int gunQuantity = 3;
	
	public S2MotherNaveShape2D() {
		super();
		
		normalStateS2D = new S2MotherStateNaveShape2D( gunQuantity ); 
		shotedStateS2D = new S2MotherStateNaveShape2D( gunQuantity );
		lowStateS2D = new S2MotherStateNaveShape2D( gunQuantity );
		destroyedStateS2D = new S2MotherStateNaveShape2D( gunQuantity ); 
		inactiveStateS2D = new S2MotherStateNaveShape2D( gunQuantity );		
	}	
