...
public class MotherNaveCFGF1T2 implements ComputerConfig {

	private int type = Computer.MOTHER;
	private int style = NaveShapeConstants.MOTHER_S2;
	private int colorStyle = NaveShapeConstants.COLOR_CONF_S1;
	private int quantity = 1;
	
	private int singlePosCellNumber = 5; 

	private int[] translateIndexes = { 0 };	
	...
	private int singlePositionatorType = SinglePositionator.CELL_Y2;
